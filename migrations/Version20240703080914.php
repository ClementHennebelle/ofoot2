 ...
 */
final class Version20240703080914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, firstclub_id INT DEFAULT NULL, secondclub_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, club_name VARCHAR(255) NOT NULL, licence_number SMALLINT NOT NULL, adress VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, INDEX IDX_B8EE3872E48FD905 (game_id), INDEX IDX_B8EE387278DE47A9 (firstclub_id), INDEX IDX_B8EE38726D14C32F (secondclub_id), INDEX IDX_B8EE38725DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tournament (id INT AUTO_INCREMENT NOT NULL, tournament_name VARCHAR(255) NOT NULL, date DATE NOT NULL, price SMALLINT NOT NULL, rewards VARCHAR(255) NOT NULL, team_count SMALLINT NOT NULL, player_team_count SMALLINT NOT NULL, location VARCHAR(255) NOT NULL, poster VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, tournament_id INT DEFAULT NULL, club_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, INDEX IDX_8D93D64933D1A3E7 (tournament_id), INDEX IDX_8D93D64961190A32 (club_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
