 ...
 */
final class Version20240716130353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, first_club_id INT DEFAULT NULL, second_club_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, tournament_id INT NOT NULL, date DATE NOT NULL, time DATETIME NOT NULL, location VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, score VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_232B318C729566CE (first_club_id), INDEX IDX_232B318C765B8A5F (second_club_id), INDEX IDX_232B318C5DFCD4B8 (winner_id), INDEX IDX_232B318C33D1A3E7 (tournament_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, tournament_name VARCHAR(255) NOT NULL, date DATE NOT NULL, price SMALLINT NOT NULL, rewards VARCHAR(255) NOT NULL, team_count SMALLINT NOT NULL, player_team_count SMALLINT NOT NULL, location VARCHAR(255) NOT NULL, poster VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_BD5FB8D961220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
